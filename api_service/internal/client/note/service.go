...
type NoteService interface {
	GetNotesByCategory(ctx context.Context, categoryUuid string) ([]byte, error)
	GetNote(ctx context.Context, uuid string) ([]byte, error)
	CreateNote(ctx context.Context, dto CreateNoteDTO) (string, error)
	UpdateNote(ctx context.Context, uuid string, dto UpdateNoteDTO) error
	DeleteNote(ctx context.Context, uuid string) error
	GetTags(ctx context.Context, tagUUIDs []string) ([]byte, error)
	CreateTag(ctx context.Context, dto CreateTagDTO) (string, error)
	DeleteTag(ctx context.Context, uuid string) error
}

func (c *client) GetNotesByCategory(ctx context.Context, categoryUuid string) ([]byte, error) {
	var notes []byte
...
func (c *client) GetNote(ctx context.Context, uuid string) ([]byte, error) {
	var note []byte
...
func (c *client) UpdateNote(ctx context.Context, uuid string, dto UpdateNoteDTO) error {
	uri, err := c.base.BuildURL(fmt.Sprintf("%s/%s", c.Resource, uuid), nil)
	if err != nil {
...
func (c *client) DeleteNote(ctx context.Context, uuid string) error {
	uri, err := c.base.BuildURL(fmt.Sprintf("%s/%s", c.Resource, uuid), nil)
	if err != nil {
		return fmt.Errorf("failed to build URL. error: %w", err)
	}
...
func (c *client) GetTags(ctx context.Context, tagUUIDs []string) ([]byte, error) {
	var tags []byte
...
func (c *client) DeleteTag(ctx context.Context, uuid string) error {
	uri, err := c.base.BuildURL(fmt.Sprintf("tags/%s", uuid), nil)
	if err != nil {
		return fmt.Errorf("failed to build URL. error: %w", err)
	}
