...
func openAPISpec() map[string]any {
	return map[string]any{
		...
		"info": map[string]any{
			...
			"version":     "1.0.0",
			"description": "Internal API for users, profiles, action history, and refresh sessions.",
		},
		...
		"components": map[string]any{
			"schemas": map[string]any{
				...
				"CreateUserSessionRequest": map[string]any{
					...
					"properties": map[string]any{
						"user_uuid":          map[string]any{"type": "string"},
						"refresh_token_hash": map[string]any{"type": "string"},
						"expires_at":         map[string]any{"type": "integer", "format": "int64"},
						"user_agent":         map[string]any{"type": "string"},
						"ip_address":         map[string]any{"type": "string"},
					},
				...
				"RotateUserSessionRequest": map[string]any{
					...
					"properties": map[string]any{
						"refresh_token_hash":     map[string]any{"type": "string"},
						"new_refresh_token_hash": map[string]any{"type": "string"},
						"expires_at":             map[string]any{"type": "integer", "format": "int64"},
						"user_agent":             map[string]any{"type": "string"},
						"ip_address":             map[string]any{"type": "string"},
					},
